var ATversion='Solofme v4.5.1',atscript=document.getElementById('AutoTrimps-script'),basepath='https://Solofme.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
